 ...
 *
 * @package FlowChart
 * @author ZhangZijing(hongweipeng)
 * @version 1.2.0
...
class FlowChart_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function footer()
    {
        ...
        $raphael_js = Helper::options()->pluginUrl . '/FlowChart/raphael.2.3.0.min.js';
        $flowchart_js = Helper::options()->pluginUrl . '/FlowChart/flowchart.1.12.3.min.js';
        echo <<<HTML
